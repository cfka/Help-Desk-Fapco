    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body" id="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                <label class="form-label" id="label">DESCRIPCIÓN DEL REPORTE DEL TECNICO</label>
                                <div class="form-line">
                                    {{-- @foreach($reportes as $reporte) --}}
                                    <textarea
                                        style="text-transform:uppercase; border-style: solid; border-width: 1px; padding-left:10px; padding-top:10px"
                                        class="form-control" name="tec_report" rows="10" cols="40"
                                        readonly>{{$reporte->tec_report}}</textarea>
                                    {{-- @endforeach --}}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <textarea
                                        style="text-transform:uppercase; border-style: solid; border-width: 1px; padding-left:10px; padding-top:10px"
                                        class="form-control" name="user_report" rows="10" cols="40"
                                        readonly>{{$reporte->user_report}}</textarea>
                                    {{-- @endforeach --}}
                                </div>
                            </div>
                        </div>
                ...
                <div class="row clearfix">
                    <div class="col-sm-3">
                        <a href="{{asset('/userhome/')}}" class="btn btn-success waves-effect" type="sumit">
