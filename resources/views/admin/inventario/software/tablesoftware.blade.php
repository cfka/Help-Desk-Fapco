                ...
                <div class="header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-1 pull-right">
                            <a href="{{asset('/software/create')}}" role="button" button class="btn btn-block bg-blue waves-effect" type="submit">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="icon-button-demo">
                                            <a href="{{asset('/software/')}}/{{$software->id}}/edit"  class="btn bg-orange waves-effect" type="sumit">
                                                <i class="material-icons">edit</i></a>
                                        </div>
                                    </td>
                                    <td>
                                            <button class="btn bg-red waves-effect icon-button-demo" title="Eliminar" type="sumit" data-toggle="modal" data-target="#mdModal{{$software->id}}">
                                                    <i class="material-icons ">delete</i>
                                            </button>
                                    </td>
                                </tr>
                                <div class="modal fade" id="mdModal{{$software->id}}" tabindex="-1" role="dialog">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Seguro desea eliminar el SOFTWARE {{$software->name}}
                                                </div>
